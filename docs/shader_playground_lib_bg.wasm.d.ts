...
export function wasm_bindgen__convert__closures__invoke0_mut__hdac3fb6c5e1bc88f(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h06e22a899b2a14fe(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h45871585ae95dc80(a: number, b: number, c: number, d: number): void;
